    ...
    <div className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div
          ...
          style={{
            backgroundImage: `url('/images/A5.jpeg')`,
          }}
        />
      ...
      <div className="absolute inset-0">
        <div
          ...
          style={{
            backgroundImage: `url('/images/OurProjectsTitle.jpeg')`,
      ...
      >
        <div className="max-w-4xl">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">Our Projects</h1>
          <p className="text-xl md:text-2xl max-w-2xl opacity-90 leading-relaxed">
            Explore our portfolio of successful electrical engineering and instrumentation projects
          </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 right-8 z-20">
        <div className="text-white/80 text-sm font-medium tracking-wider">PROJECTS / PORTFOLIO</div>
      </div>
      */}
